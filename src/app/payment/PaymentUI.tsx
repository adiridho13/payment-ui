    ...
    return <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div className="w-full max-w-md space-y-8">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
                ...
                <input
                    ...
                    onChange={e => {
                        ...
                        val = val.replace(/\D/g, '');
                        // hapus semua leading zero selama masih ada digit setelahnya
                        // (0 saja tetap "0")
                        val = val.replace(/^0+(?!$)/, '');
                        setFeatureCount(val);
                    }}
                    onBlur={() => {
                        // kalau kosong setelah blur, set ke "0" atau minimal sesuai kebutuhan
                        if ('' !== featureCount) {
                            return;
                        }
                        setFeatureCount('0');
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                {allOptions.map(group => <div key={group.label} className="border-b border-gray-200 last:border-0">
                        <button
            ...
            {selectedOption && <div className="bg-white shadow-lg rounded-lg p-6">
